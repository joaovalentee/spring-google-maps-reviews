...
public class MapsService {
    ...
    private String GOOGLE_MAPS_PLACE_ID = null;
    private String url;
    ...
    public MapsService() {
        this.GOOGLE_MAPS_API_KEY = System.getenv("GOOGLE_MAPS_API_KEY");
        this.GOOGLE_MAPS_PLACE_ID = System.getenv("GOOGLE_MAPS_PLACE_ID");

        if (this.GOOGLE_MAPS_API_KEY == null && this.GOOGLE_MAPS_PLACE_ID == null) throw new RuntimeException("ENV variables not defined.");
